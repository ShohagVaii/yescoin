...
Author       :   @SHOHAG_VAII
Github       :   @ShohagVaii
Telegram     :   @FAKE_TECH_BD™
TOOLS        :   @YES COIN HACK
------------------------------------------------------
 © 𝘕𝘰𝘵 𝘍𝘰𝘳 𝘚𝘦𝘭𝘭, 𝘐𝘵’𝘴 𝘛𝘰𝘵𝘢𝘭𝘭𝘺 𝘍𝘳𝘦𝘦
--------------------------------------------------------
     """)
...
def claim_invite_bonus(token):
    ...
    url='https://api-backend.yescoin.gold/invite/claimGiftBox?packId=P8SXQe'
...
def get_invitation(token):
    ...
    try:
        ...
        if data['code'] == 0:
            ...
            print(f"{Fore.BLUE + Style.BRIGHT} \n -\{Fore.WHITE + Style.BRIGHT} Invited by SHOHAG VAII {Fore.BLUE + Style.BRIGHT}/-", flush=True)
